 ...
 * Color sensor is in MODE 1 (Reflection).  v1 records the LUMP sample
 * timestamp and the reflection percent value; distance / encoder
 * overlay is left to a future revision that wires drivebase state in.
 ****************************************************************************/
...
const struct capture_schema_s g_capture_schema_color_reflection_run =
{
  ...
  .fields       =
  {
    ...
    CAPTURE_FIELD_INIT(color_reflection_run, distance_mm,    i32, "mm", 0),
