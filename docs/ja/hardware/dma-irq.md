...
|---|---|---|---|---|
| **0x00** | **0** | **LUMP UART (HIPRI direct vector)** | base=0/1 → preempt=0 (同一) | **Issue #100 案D、`stm32_bringup.c` (step 1.5)** |
...
|---|---|---|---|
| TIM1 | Motor PWM (Port A/B) | ✅ 実装済 (#80) | 12 kHz PWM, PSC=8, ARR=1000 |
| TIM2 | ADC trigger (TRGO 1 kHz) | ✅ 実装済 | 同一 |
| TIM3 | Motor PWM (Port E/F) | ✅ 実装済 (#80) | 12 kHz PWM |
| TIM4 | Motor PWM (Port C/D) | ✅ 実装済 (#80) | 12 kHz PWM |
