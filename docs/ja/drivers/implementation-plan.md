...
- DAC1 CH1 (PA4) でアナログ音声信号出力
- スピーカー有効化: PC10 (GPIO HIGH)
- TIM6 TRGO でサンプルレート制御、DMA1_Stream5 でバッファ転送
...
**注意**: Hub のボタン入力は GPIO ではなく ADC 抵抗ラダー方式。PA1 の電圧レベルから押下ボタンを判定する。
