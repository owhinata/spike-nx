...
nsh> btsensor status          # running / pid / bt 状態 / rfcomm / frame stats
...
- Pairing 完了は `HCI_EVENT_SIMPLE_PAIRING_COMPLETE` (status≠0 で FAIL_BLINK)、SPP 確立は `RFCOMM_EVENT_CHANNEL_OPENED` で PAIRED 遷移
