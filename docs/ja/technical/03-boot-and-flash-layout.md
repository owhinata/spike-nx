...
STM32F413VG は 1.5 MB (1536 KB) のフラッシュを持つ。非均一セクタ構成。
...
### Bank 2 (512 KB, セクタ 12-15)

| セクタ | アドレス | サイズ | 用途 |
|--------|---------|-------|------|
| 12 | `0x08100000` | 128 KB | 追加領域 |
| 13 | `0x08120000` | 128 KB | 追加領域 |
| 14 | `0x08140000` | 128 KB | 追加領域 |
| 15 | `0x08160000` | 128 KB | 追加領域 |

**合計**: 4x16 KB + 1x64 KB + 11x128 KB = 1536 KB = 1.5 MB
